...
final class WindowsSelectorImpl extends SelectorImpl {
    ...
    private static int addressSize = getAddressSize();
    ...
    private final class SubSelector {
        ...
        // to native select().
		@cli.System.Security.SecuritySafeCriticalAttribute.Annotation
		private long unsafeMalloc(){
			return unsafe.allocateMemory(SIZEOF_FD_SET * 6);
		}
        private final long fdsBuffer = unsafeMalloc();
