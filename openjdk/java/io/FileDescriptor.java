...
public final class FileDescriptor {
     ...
     */
    @ikvm.lang.Property(get = "get_fd", set = "set_fd")
    private int fd;

    @ikvm.lang.Property(get = "get_handle", set = "set_handle")
    private long handle;
	private int realfd;
	...
	//ikNIO may manually override fd and handle via JNI
	private boolean fd_override;
	private boolean handle_override;
    ...
    private long get_handle()
    {
        if(handle_override){
			return realhandle;
		} else if (ikvm.internal.Util.WINDOWS)
        {
	...
	private void set_fd(int val){
		realfd = val;
		fd_override = true;
	}
	private void set_handle(long val){
		realhandle = val;
		handle_override = true;
	}
    ...
    public boolean valid() {
        return stream != null || socket != null || fd_override || handle_override;
    }
