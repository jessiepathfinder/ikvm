...
public abstract class ClassLoader {
    ...
    */
    ...
    static void initializeLibraryPaths(java.util.Properties props)
    {
		...
		//[IKVM] ikNative boot path loading
		String iknativebootpath = cli.System.IO.Path.GetDirectoryName(cli.System.Reflection.Assembly.GetExecutingAssembly().get_Location());
		String extbootpath = props.getProperty("sun.boot.library.path", null);
		if(extbootpath == null){
			sun_boot_library_path = iknativebootpath;
		} else{
			sun_boot_library_path = new StringBuilder(iknativebootpath).append(';').append(extbootpath).toString();
		}
